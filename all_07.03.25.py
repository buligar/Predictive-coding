        ...
        for measure_name in measure_names:
            ...
            for p_within_str in data_measure.keys():
                ...
                ax.set_title(
                    ...
                    f'Метрики: {measure_name} и random',
                    fontsize=13
                )
...
def sim(p_within, p_between, nu_ext_over_nu_thr, J, J2, refractory_period, sim_time, plotting_flags,
    ...
    centrality = print_centrality(C_total_matrix, N1, n_neurons, p_input, measure_name="random", direct_1_2=True)
    ...
    avg_neuron_spikes_cluster2_list = avg_neuron_spikes_cluster2_list
    print(avg_neuron_spikes_cluster2_list)
    print(np.array(avg_neuron_spikes_cluster2_list).shape)
    # Построение графиков
    ...
    if plotting_flags.get('connectivity2', False) and 'ax_connectivity2' in plotting_flags:
    ...
    return avg_neuron_spikes_cluster2_list, time_window_centers, C_total, spike_indices, centrality, p_in_measured, p_out_measured, max_rate
                ...
                for p_within in p_within_values:
                    ...
                    for p_input in p_input_values:
                        ...
                        for measure_name in measure_names:
                            ...
                            for measure_name_2 in [measure_name, 'random']:
                                ...
                                for p_between in p_between_values:
                                    ...
                                    if any([do_plot_granger, do_plot_spikes, do_plot_rates, 
                                            do_plot_rates2, do_plot_connectivity2, do_plot_psd, 
                                    ...
                                    if fig is not None:
                                        ...
                                        if do_plot_connectivity2:
                                            ax_connectivity2 = fig.add_subplot(gs[1, 2])
                                            plotting_flags['ax_connectivity2'] = ax_connectivity2
                                        ...
                                        fig.suptitle(
                                            ...
                                            f'measure={measure_name_2}, Time={current_time} ms'
                                        )
                                    ...
                                    for test_num in range(num_tests):
                                        ...
                                        measure_name_prev = measure_name_2
                                    ...
                                    detailed_spike_data_for_3d[I0_value][measure_name_2][p_within_str][p_between] = {
                                    ...
                                    if p_between not in spike_counts_second_cluster[I0_value][measure_name_2][p_within_str]:
                                        spike_counts_second_cluster[I0_value][measure_name_2][p_within_str][p_between] = []
                                    spike_counts_second_cluster[I0_value][measure_name_2][p_within_str][p_between].append(
                                        avg_window_avg_neuron_spikes_cluster2_tests
                                    )

                                    # Сохраняем в spike_counts_second_cluster_for_input
                                    sc_input = spike_counts_second_cluster_for_input[I0_value][measure_name_2][p_within_str]
                                ...
                                if images:
                                    gif_filename = (
                                        ...
                                        f'p_input_{p_input_str}_Time_{current_time}ms_{measure_name_2}.gif'
                                    )
