...
num_tests = 5  # Увеличено для получения стандартного отклонения
J = 0.1
g = 6
time = 5000
sim_time = time * ms
...
I0_values = np.arange(10, 110, 10)  # От 10 мВ до 100 мВ с шагом 10 мВ
    ...
    for p_within_idx, p_within in enumerate(p_within_values):
        ...
        for p_between in p_between_values:
            ...
            for test_num in range(num_tests):
                ...
                spike_counts_second_cluster[I0_value][p_within][p_between].append(average_spikes)
